package thelm.packagedexexexcrafting.integration.appeng.blockentity;
...
public class AELegendaryCrafterBlockEntity extends LegendaryCrafterBlockEntity implements IInWorldGridNodeHost, IGridNodeListener<AELegendaryCrafterBlockEntity>, IActionHost {

	public boolean firstTick = true;
	public IActionSource source;
	public IManagedGridNode gridNode;

	public AELegendaryCrafterBlockEntity(BlockPos pos, BlockState state) {
		super(pos, state);
	...
	@Override
	public void onSaveChanges(AELegendaryCrafterBlockEntity nodeOwner, IGridNode node) {
		setChanged();
	}
	...
	public IManagedGridNode getMainNode() {
		if(gridNode == null) {
			...
			gridNode.setVisualRepresentation(LegendaryCrafterBlock.INSTANCE);
			...
			if(ownerUUID != null && level instanceof ServerLevel) {
				gridNode.setOwningPlayerId(Objects.requireNonNull(IPlayerRegistry.getMapping(level)).getPlayerId(ownerUUID));
			}
		}
		return gridNode;
	}
